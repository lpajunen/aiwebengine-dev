# Contributing to aiwebengine-dev
...
1. Check if the issue already exists in the [Issues](https://github.com/lpajunen/aiwebengine-dev/issues) section
...
6. Create a Pull Request:
   - Go to the [repository](https://github.com/lpajunen/aiwebengine-dev) on GitHub
...
- Open a [Discussion](https://github.com/lpajunen/aiwebengine-dev/discussions) for questions
- Create an [Issue](https://github.com/lpajunen/aiwebengine-dev/issues) for problems
